...
const cardGradients = [
  "from-green-500 via-emerald-500 to-fuchsia-500",
  "from-violet-500 via-purple-500 to-indigo-500",
  "from-blue-500 via-cyan-500 to-teal-500",
  "from-emerald-500 via-green-500 to-lime-500",
  "from-amber-500 via-orange-500 to-red-500",
  "from-indigo-500 via-blue-500 to-cyan-500",
  "from-fuchsia-500 via-emerald-500 to-green-500",
  ...
  return (
    <div className="space-y-5">
      <div className="relative">
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/20 via-purple-500/20 to-blue-500/20 rounded-xl blur-lg" />
        <div className="relative flex items-center gap-2 bg-white/80 backdrop-blur-sm rounded-xl p-3 border border-white/50 shadow-md">
          <div className="p-2 bg-gradient-to-br from-emerald-500 to-purple-600 rounded-lg">
          ...
          />
          <Badge className="bg-gradient-to-r from-emerald-500 to-purple-600 text-white border-0 px-3 py-1 text-xs">
        ...
        <Card className="border-2 border-dashed border-gray-200 bg-gradient-to-br from-gray-50 to-white">
          <CardContent className="flex flex-col items-center justify-center py-12">
            <div className="relative mb-4">
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-500 to-purple-600 rounded-full blur-xl opacity-30 animate-pulse" />
              <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-emerald-500 to-purple-600 flex items-center justify-center text-white">
            ...
            <Link href="/users/new">
              <Button className="bg-gradient-to-r from-emerald-500 to-purple-600 text-white hover:opacity-90 transition-opacity px-6 py-2 rounded-lg shadow-lg shadow-emerald-500/30 text-sm">
