        ...
        <div className="container mx-auto px-6 max-w-7xl py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Image src="/logo.png" alt="RoseSmile" width={48} height={48} className="w-12 h-12" />
              <div>
                <h1 className="text-base font-semibold text-gray-900">RoseSmile</h1>
            ...
            <div className="flex items-center gap-2">
              {user && profile ? (
                ...
                <Link href="/auth/login">
                  <button className="flex items-center gap-1.5 text-xs h-9 px-4 bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-700 hover:to-rose-700 text-white rounded-lg transition-all">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-5xl py-16 relative">
          <div className="text-center max-w-2xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-100 to-rose-100 text-pink-700 px-4 py-2 rounded-full text-sm font-medium mb-6 shadow-sm">
              <Image src="/logo.png" alt="RoseSmile" width={28} height={28} className="w-7 h-7" />
              ابتسامة الوردة
            </div>
            ...
            {user && profile ? (
                ...
                {profile.role === "admin" && (
                  <>
                    ...
                    <Link href="/users" className="group">
                      <div className="relative bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 hover:border-pink-200 overflow-hidden">
                        ...
                        <div className="absolute -bottom-4 -right-4 w-20 h-20 bg-pink-100 rounded-full opacity-0 group-hover:opacity-50 transition-all duration-500 group-hover:scale-150" />
                        <div className="relative">
                          <div className="w-14 h-14 bg-gradient-to-br from-pink-500 to-rose-500 rounded-xl flex items-center justify-center mb-4 mx-auto shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
              ...
              <div className="flex flex-col items-center gap-4">
                <Link href="/auth/login" className="group">
                  <div className="relative bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 hover:border-pink-200 overflow-hidden min-w-[200px]">
                    <div className="absolute inset-0 bg-gradient-to-br from-pink-500/10 to-rose-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-pink-100 rounded-full opacity-0 group-hover:opacity-50 transition-all duration-500 group-hover:scale-150" />
                    <div className="relative">
                      <div className="w-16 h-16 bg-gradient-to-br from-pink-500 to-rose-500 rounded-xl flex items-center justify-center mb-4 mx-auto shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
      ...
      <footer className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-8 mt-8">
        <div className="container mx-auto px-6 text-center max-w-6xl">
          <div className="flex items-center justify-center gap-3 mb-3">
            <Image src="/logo.png" alt="RoseSmile" width={32} height={32} className="w-8 h-8 opacity-80" />
            <p className="text-sm text-gray-300">© 2025 RoseSmile. جميع الحقوق محفوظة.</p>
          </div>
        </div>
      </footer>
    </div>
