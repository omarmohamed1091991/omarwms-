    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
          ...
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-pink-500 to-purple-600 rounded-xl blur-md opacity-30 group-hover:opacity-50 transition-opacity" />
                <Image src="/logo.png" alt="RoseSmile" width={40} height={40} className="relative w-10 h-10" />
              </div>
              <div>
                <h1 className="text-base font-bold text-gray-900">إدارة المستخدمين</h1>
                <p className="text-xs text-gray-500">نظام RoseSmile</p>
              </div>
            </Link>
            <div className="flex items-center gap-3">
              ...
              <Link href="/users/new">
                <Button
                  size="sm"
                  className="bg-gradient-to-r from-pink-500 to-purple-600 hover:opacity-90 text-white text-xs h-9 px-4 rounded-xl shadow-lg shadow-pink-500/30"
                >
      ...
      <div className="container mx-auto px-6 max-w-7xl py-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
          ...
          {/* بطاقة الإجمالي */}
          <div className="group relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-pink-500 to-rose-500 rounded-3xl blur-lg opacity-30 group-hover:opacity-50 transition-opacity" />
            <Card className="relative p-6 bg-gradient-to-br from-pink-500 to-rose-600 text-white border-0 rounded-2xl overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -translate-y-1/2 translate-x-1/2" />
              <div className="absolute bottom-0 left-0 w-24 h-24 bg-white/10 rounded-full translate-y-1/2 -translate-x-1/2" />
              <div className="relative flex items-center justify-between">
                <div>
                  <p className="text-pink-100 text-sm mb-1">إجمالي المستخدمين</p>
        ...
        <div className="relative">
          <div className="absolute -inset-1 bg-gradient-to-r from-pink-500/10 via-purple-500/10 to-blue-500/10 rounded-3xl blur-xl" />
          <Card className="relative p-6 bg-white/80 backdrop-blur-sm border-0 shadow-xl rounded-2xl">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="p-2.5 bg-gradient-to-br from-pink-500 to-purple-600 rounded-xl">
              ...
              <Link href="/users/new">
                <Button
                  size="sm"
                  className="bg-gradient-to-r from-pink-500 to-purple-600 text-white hover:opacity-90 text-xs h-9 px-4 rounded-xl"
                >
            ...
            {!users || users.length === 0 ? (
              <div className="text-center py-16">
                <div className="relative inline-block mb-6">
                  ...
                  <div className="relative p-6 bg-gradient-to-br from-pink-50 to-purple-50 rounded-full">
                ...
                <Link href="/users/new">
                  <Button className="bg-gradient-to-r from-pink-500 to-purple-600 hover:opacity-90 text-white px-8 py-3 rounded-xl shadow-lg shadow-pink-500/30">
                    <UserPlus className="w-4 h-4 ml-2" />
                    إضافة أول مستخدم
                  </Button>
                </Link>
